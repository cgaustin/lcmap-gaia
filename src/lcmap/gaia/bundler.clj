...
(defn get-bundle-values
  ...
  (let [layer_info (gdal/info tif_name)
        ...
        coord_lr (get-in layer_info [:cornerCoordinates :lowerRight])
        coord_ul_converted (gdal/geographic-coords coord_ul)
        coord_ur_converted (gdal/geographic-coords coord_ur)
        coord_ll_converted (gdal/geographic-coords coord_ll)
        coord_lr_converted (gdal/geographic-coords coord_lr)
        coord_north (zp (max (second coord_ul_converted) (second coord_ur_converted)) 10)
        coord_south (zp (min (second coord_ll_converted) (second coord_lr_converted)) 10)
        coord_east  (zp (max (first coord_ur_converted) (first coord_lr_converted)) 10)
        coord_west  (zp (min (first coord_ul_converted) (first coord_ll_converted)) 10)
        hhh (subs tile 0 3)
        vvv (subs tile 3 6)
